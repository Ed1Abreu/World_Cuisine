...
<div id="j-main-container" class="span10">
    <div class="import-container">
        <div style="margin-bottom: 20px;">
            <?php echo Text::_('COM_NICEPAGE_IMPORT_DESC'); ?>
        </div>
        <div class="import-group clearfix">
            <div class="import-label">
                <label for="file-field"><?php echo Text::_('COM_NICEPAGE_IMPORT_LABEL'); ?></label>
            </div>
            <div class="import-control">
                <input type="file" name="file" id="file-field" multiple="true" />
                <button style="background: rgb(61, 97, 143);color: white;" id="upload-all" disabled class="btn"><?php echo Text::_('COM_NICEPAGE_IMPORT_BUTTON_TEXT'); ?></button>
            </div>
        </div>
        <div class="import-group clearfix">
            <div class="import-control">
            ...
            <div class="import-label">
                <label for="checkbox-field"><?php echo Text::_('COM_NICEPAGE_IMPORT_REPLACE_LABEL'); ?></label>
            </div>
        </div>
        <div class="import-group clearfix">
            <div class="import-control">
            ...
            <div class="import-label">
                <label for="checkbox-field"><?php echo Text::_('COM_NICEPAGE_IMPORT_UPDATE_PLUGIN_SETTINGS'); ?>
                </label>
            </div>
        </div>
        <div id="log"></div>
