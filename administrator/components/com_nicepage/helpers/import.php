...
//    private function _langCodes() {
//        $editorLangCodes = <<<JSON
//{"Abkhazian":"ab","Afar":"aa","Afrikaans":"af","Akan":"ak","Albanian":"sq","Amharic":"am","Arabic":"ar","Arabic Egypt":"eg","Aragonese":"an","Armenian":"hy","Assamese":"as","Avaric":"av","Avestan":"ae","Aymara":"ay","Azerbaijani":"az","Bambara":"bm","Bashkir":"ba","Basque":"eu","Belarusian":"be","Bengali":"bn","Bihari":"bh","Bislama":"bi","Bosnian":"bs","Breton":"br","Bulgarian":"bg","Burmese":"my","Catalan":"ca","Chamorro":"ch","Chechen":"ce","Chinese":"zh","Chuvash":"cv","Cornish":"kw","Corsican":"co","Cree":"cr","Croatian":"hr","Czech":"cs","Danish":"da","Dutch":"nl","Dzongkha":"dz","English":"en","English US":"ena","Esperanto":"eo","Estonian":"et","Ewe":"ee","Faroese":"fo","Fijian":"fj","Finnish":"fi","French":"fr","Galician":"gl","Gaelic":"gd","Georgian":"ka","German":"de","Greek":"el","Greenlandic":"kl","Guarani":"gn","Gujarati":"gu","Haitian":"ht","Hausa":"ha","Hebrew":"he","Herero":"hz","Hindi":"hi","Hiri Motu":"ho","Hungarian":"hu","Icelandic":"is","Ido":"io","Igbo":"ig","Indonesian":"id","Interlingua":"ia","Interlingue":"ie","Inuktitut":"iu","Inupiak":"ik","Irish":"ga","Italian":"it","Japanese":"ja","Javanese":"jv","Kannada":"kn","Kanuri":"kr","Kashmiri":"ks","Kazakh":"kk","Khmer":"km","Kikuyu":"ki","Kinyarwanda":"rw","Kirundi":"rn","Kyrgyz":"ky","Komi":"kv","Kongo":"kg","Korean":"ko","Kurdish":"ku","Kwanyama":"kj","Lao":"lo","Latin":"la","Latvian":"lv","Limburgish":"li","Lingala":"ln","Lithuanian":"lt","Luganda":"lg","Luxembourgish":"lb","Macedonian":"mk","Malagasy":"mg","Malay":"ms","Malayalam":"ml","Maltese":"mt","Maori":"mi","Marathi":"mr","Marshallese":"mh","Moldavian":"mo","Mongolian":"mn","Nauru":"na","Navajo":"nv","Ndonga":"ng","Nepali":"ne","Norwegian":"no","Nuosu":"ii","Occitan":"oc","Ojibwe":"oj","Oriya":"or","Ossetian":"os","Pāli":"pi","Pashto":"ps","Persian":"fa","Polish":"pl","Portuguese":"pt","Punjabi":"pa","Quechua":"qu","Romansh":"rm","Romanian":"ro","Russian":"ru","Sami":"se","Samoan":"sm","Sango":"sg","Sanskrit":"sa","Serbian":"sr","Sesotho":"st","Setswana":"tn","Shona":"sn","Sindhi":"sd","Sinhalese":"si","Siswati":"ss","Slovak":"sk","Slovenian":"sl","Somali":"so","Spanish":"es","Sundanese":"su","Swahili":"sw","Swedish":"sv","Tagalog":"tl","Tahitian":"ty","Tajik":"tg","Tamil":"ta","Tatar":"tt","Telugu":"te","Thai":"th","Tibetan":"bo","Tigrinya":"ti","Tonga":"to","Tsonga":"ts","Turkish":"tr","Turkmen":"tk","Twi":"tw","Uyghur":"ug","Ukrainian":"uk","Urdu":"ur","Uzbek":"uz","Venda":"ve","Vietnamese":"vi","Volapük":"vo","Wallon":"wa","Welsh":"cy","Wolof":"wo","Frisian":"fy","Xhosa":"xh","Yiddish":"yi","Yoruba":"yo","Zhuang":"za","Zulu":"zu"}
//JSON;
//
//        $cmsLangCodes = array('ar' => 'ar-AA', 'bg' => 'bg-BG', 'ca' => 'ca-ES', 'zh' => 'zh-CN',
//            /*'zh2' => 'zh-TW',*/ 'cs' => 'cs-CZ', 'da' => 'da-DK', 'nl' => 'nl-NL', 'en' => 'en-AU',
//            'ena' => 'en-US', /*'en1' => 'en-CA', 'en2' => 'en-NZ',*/ 'et' => 'et-EE', 'fi' => 'fi-FI',
//            /*'nl2' => 'nl-BE',*/ 'fr' => 'fr-FR', 'ka' => 'ka-GE', 'de' => 'de-DE', /*'de2' => 'de-AT',
//            'de3' => 'de-LI', 'de4' => 'de-LU', 'de5' => 'de-CH',*/ 'el' => 'el-GR', 'hu' => 'hu-HU',
//            'it' => 'it-IT', 'ja' => 'ja-JP', 'kk' => 'kk-KZ', 'lt' => 'lt-LT', 'nb' => 'nb-NO',
//            'fa' => 'fa-IR', 'pl' => 'pl-PL', 'pt' => 'pt-BR', 'pt2' => 'pt-PT', 'ro' => 'ro-RO',
//            'ru' => 'ru-RU', 'sr' => 'sr-YU', 'sk' => 'sk-SK', 'sl' => 'sl-SI', 'es' => 'es-ES',
//            'sv' => 'sv-SE', 'ta' => 'ta-IN', 'th' => 'th-TH', 'tr' => 'tr-TR', 'uk' => 'uk-UA',
//            'cy' => 'cy-GB');
//    }
//
//    private function _getNeedInstallLanguages($langs) {
//        $existingLanguages = LanguageHelper::getContentLanguages(array(0, 1));
//        $needInstallLanguages = array();
//        foreach ($langs as $lang) {
//            $found = false;
//            foreach ($existingLanguages as $langCode => $language) {
//                if ($language->sef === $lang['name']) {
//                    $found = true;
//                }
//            }
//            if (!$found) {
//                array_push($needInstallLanguages, $lang);
//            }
//        }
//        return $needInstallLanguages;
//    }
//
//    private function _installNonExistsLanguages($langs)
//    {
//        $needInstallLanguages = $this->_getNeedInstallLanguages($langs);
//        if (count($needInstallLanguages) < 1) {
//            return true;
//        }
//
//        return false;
        ...
        foreach ($this->_data['Pages'] as & $articleData) {
            ...
            if (!is_null($article)) {
                ...
                if (isset($articleData['properties'])) {
                    ...
                    $properties['fonts'] = str_replace('page-fonts.css', $fontsPath . 'page-' . $article->id . '-fonts.css', $properties['fonts']);
